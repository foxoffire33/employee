...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'statusTest' => Yii::t('common','Status'),
    ...
    {
        if($this->isNewRecord){
            $this->genaretedPassword = Yii::$app->security->generateRandomString(12);
            $this->setPassword($this->genaretedPassword);
        }
